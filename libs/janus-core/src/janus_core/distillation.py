...
from janus_core.prompts import EPISODE_DISTILLATION_PROMPT, FACT_DISTILLATION_PROMPT
...
class MemoryDistiller:
    ...
    async def distill_episodes(
        ...
        try:
            ...
            result = parse_json_response(response, {}, "Episode distillation")
    ...
    async def distill_facts(
        ...
        try:
            ...
            result = parse_json_response(response, {}, "Fact distillation")
